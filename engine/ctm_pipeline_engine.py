...
Description:
    ...
    - Configures and deploys strictly into Control-M Planning Domain (No automatic execution).
...
class ControlMAutomationEngine:
    ...
    def deploy_job(self, file_path: Path) -> bool:
        ...
        try:
            ...
            print(f"  [ERROR] Configuration in Planning failed ({e}).")
...
def main():
    ...
    if failed:
        ...
        print("\n[SUCCESS] ALL JOBS CONFIGURED IN CONTROL-M PLANNING SUCCESSFULLY!")
        sys.exit(0)
